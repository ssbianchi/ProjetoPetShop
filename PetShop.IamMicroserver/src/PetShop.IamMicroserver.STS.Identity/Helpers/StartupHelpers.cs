...
using SendGrid;
using PetShop.IamMicroserver.STS.Identity.Configuration;
using PetShop.IamMicroserver.STS.Identity.Configuration.ApplicationParts;
using PetShop.IamMicroserver.STS.Identity.Configuration.Constants;
using PetShop.IamMicroserver.STS.Identity.Configuration.Interfaces;
using PetShop.IamMicroserver.STS.Identity.Helpers.Localization;
using PetShop.IamMicroserver.STS.Identity.Services;
using System.Linq;
...
namespace PetShop.IamMicroserver.STS.Identity.Helpers
{
